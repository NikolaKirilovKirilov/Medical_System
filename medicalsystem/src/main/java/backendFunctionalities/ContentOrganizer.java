...
public class ContentOrganizer {
    ...
    public JPanel sortEntries(JComboBox<String> comboBox, ArrayList<User> list, JPanel contentPanel, String instance) {
        String option = Objects.requireNonNull(comboBox.getSelectedItem()).toString();
        ...
        if (comparator != null) {
            list.sort(comparator);
            return refreshEntriesDisplay(list, contentPanel, instance);  // Redraw the UI
        }
        return null;
    }
    ...
    private JPanel refreshEntriesDisplay(ArrayList<User> entries, JPanel contentPanel, JPanel contentButtonPanel, String instance) {
        ...
        JButton insertButton = sc.createStyledButton("Вписване на " + instance, headerColor, hoverBackgroundColor, hoverTextColor);
    ...
    private JPanel refreshEntriesDisplay(ArrayList<User> entries, JPanel contentPanel, String instance) {
        contentPanel.removeAll();
